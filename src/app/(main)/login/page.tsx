    ...
    <div className="min-h-screen pt-24 pb-16 px-6 flex items-center justify-center">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-moon/50 text-sm mt-2">Sign in to unlock all chapters</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-8 space-y-6">
          ...
          {(error || oauthError) && (
            <div className="flex items-center gap-2 p-3 rounded-lg bg-red-500/10 border border-red-500/20 text-red-400 text-sm">
              ...
              <span>{error || "OAuth login failed. Please try again."}</span>
            </div>
          )}
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={!!loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-all disabled:opacity-50 text-sm font-medium"
            >
              {loading === "google" ? (
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={!!loading}
              className="neon-btn w-full py-3 rounded-xl text-sm flex items-center justify-center gap-2 disabled:opacity-50"
            >

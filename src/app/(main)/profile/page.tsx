        ...
        {role !== "free" && (
          <div className="glass-card rounded-2xl p-6 mb-6 space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              ...
              <div className="p-3 rounded-xl bg-white/5">
                <div className="text-xs text-moon/40 mb-1">Next Billing</div>
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-sm text-moon transition-all disabled:opacity-50 flex items-center gap-2"
            >
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                ...
                <p className="text-xs text-moon/40 mt-1">
                  Premium $7.99/mo — cancel anytime
                </p>
              </div>
              <Link
                href="/pricing"
